...
class Snapshots
{
    ...
    /**
     * @var \One\VmPool\VmPool\Vm\Snapshots\Snapshot[] $snapshot
     */
    private $snapshot = [
     ...
     *
     * @return self
     * @param \One\VmPool\VmPool\Vm\Snapshots\Snapshot $snapshot
     */
    public function addToSnapshot(\One\VmPool\VmPool\Vm\Snapshots\Snapshot $snapshot)
    {
     ...
     * Gets as snapshot
     *
     * @return \One\VmPool\VmPool\Vm\Snapshots\Snapshot[]
     */
