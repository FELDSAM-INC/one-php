...
class Quotas
{
    ...
    /**
     * @var \One\UserPool\UserPool\Quotas\DatastoreQuota\Datastore[] $datastoreQuota
     */
    private $datastoreQuota = null;

    /**
     * @var \One\UserPool\UserPool\Quotas\NetworkQuota\Network[] $networkQuota
     */
    private $networkQuota = null;

    /**
     * @var \One\UserPool\UserPool\Quotas\VmQuota $vmQuota
     */
    private $vmQuota = null;

    /**
     * @var \One\UserPool\UserPool\Quotas\ImageQuota\Image[] $imageQuota
     */
     ...
     */
    public function addToDatastoreQuota(\One\UserPool\UserPool\Quotas\DatastoreQuota\Datastore $datastore)
    {
     ...
     *
     * @param \One\UserPool\UserPool\Quotas\DatastoreQuota\Datastore[] $datastoreQuota
     * @return self
     */
     ...
     */
    public function addToNetworkQuota(\One\UserPool\UserPool\Quotas\NetworkQuota\Network $network)
    {
     ...
     *
     * @param \One\UserPool\UserPool\Quotas\NetworkQuota\Network[] $networkQuota
     * @return self
     */
     ...
     * Gets as vmQuota
     *
     * @return \One\UserPool\UserPool\Quotas\VmQuota
     */
     ...
     * Sets a new vmQuota
     *
     * @param \One\UserPool\UserPool\Quotas\VmQuota $vmQuota
     * @return self
     */
    public function setVmQuota(\One\UserPool\UserPool\Quotas\VmQuota $vmQuota)
    {
     ...
     */
    public function addToImageQuota(\One\UserPool\UserPool\Quotas\ImageQuota\Image $image)
    {
     ...
     *
     * @param \One\UserPool\UserPool\Quotas\ImageQuota\Image[] $imageQuota
     * @return self
     */
