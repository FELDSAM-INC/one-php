...
class NetworkQuota
{
    ...
    /**
     * @var \One\UserPool\UserPool\DefaultUserQuotas\NetworkQuota\Network[] $network
     */
    private $network = [
     ...
     */
    public function addToNetwork(\One\UserPool\UserPool\DefaultUserQuotas\NetworkQuota\Network $network)
    {
