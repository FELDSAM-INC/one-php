...
class ImageQuota
{
    ...
    /**
     * @var \One\UserPool\UserPool\DefaultUserQuotas\ImageQuota\Image[] $image
     */
    private $image = [
     ...
     */
    public function addToImage(\One\UserPool\UserPool\DefaultUserQuotas\ImageQuota\Image $image)
    {
        $this->image[] = $image;
        return $this;
    }
