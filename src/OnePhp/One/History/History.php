...
class History
{
     ...
     * Sets a new vm
     *
     * @param \One\History\History\Vm $vm
     * @return self
     */
    public function setVm(\One\History\History\Vm $vm)
    {
        $this->vm = $vm;
        return $this;
    }
