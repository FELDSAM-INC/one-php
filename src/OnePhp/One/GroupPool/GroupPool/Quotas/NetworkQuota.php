...
class NetworkQuota
{
    ...
    /**
     * @var \One\GroupPool\GroupPool\Quotas\NetworkQuota\Network[] $network
     */
    private $network = [
     ...
     */
    public function addToNetwork(\One\GroupPool\GroupPool\Quotas\NetworkQuota\Network $network)
    {
