...
class DatastoreQuota
{
    ...
    /**
     * @var \One\User\User\DefaultUserQuotas\DatastoreQuota\Datastore[] $datastore
     */
    private $datastore = [
     ...
     */
    public function addToDatastore(\One\User\User\DefaultUserQuotas\DatastoreQuota\Datastore $datastore)
    {
