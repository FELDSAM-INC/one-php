...
class Vm
{
    ...
    /**
     * @var \One\Vm\Vm\Permissions $permissions
     */
    ...
    /**
     * @var \One\Vm\Vm\Template $template
     */
    private $template = null;

    /**
     * @var \One\Vm\Vm\UserTemplate $userTemplate
     */
    private $userTemplate = null;

    /**
     * @var \One\Vm\Vm\HistoryRecords\History[] $historyRecords
     */
    private $historyRecords = null;

    /**
     * @var \One\Vm\Vm\Snapshots[] $snapshots
     */
    private $snapshots = [
     ...
     *
     * @param \One\Vm\Vm\Permissions $permissions
     * @return self
     */
    public function setPermissions(\One\Vm\Vm\Permissions $permissions)
    {
     ...
     * Sets a new lock
     *
     * @param \One\Vm\Vm\Lock $lock
     * @return self
     */
    public function setLock(\One\Vm\Vm\Lock $lock)
    {
        $this->lock = $lock;
        return $this;
    }
     ...
     * Sets a new template
     *
     * @param \One\Vm\Vm\Template $template
     * @return self
     */
    public function setTemplate(\One\Vm\Vm\Template $template)
    {
     ...
     *
     * @param \One\Vm\Vm\UserTemplate $userTemplate
     * @return self
     */
    public function setUserTemplate(\One\Vm\Vm\UserTemplate $userTemplate)
    {
     ...
     */
    public function addToHistoryRecords(\One\Vm\Vm\HistoryRecords\History $history)
    {
     ...
     *
     * @param \One\Vm\Vm\HistoryRecords\History[] $historyRecords
     * @return self
     */
     ...
     *
     * @return self
     * @param \One\Vm\Vm\Snapshots $snapshots
     */
    public function addToSnapshots(\One\Vm\Vm\Snapshots $snapshots)
    {
