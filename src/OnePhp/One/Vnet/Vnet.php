...
class Vnet
{
    ...
    /**
     * @var \One\Vnet\Vnet\Lock $lock
     */
    private $lock = null;

    /**
     * @var \One\Vnet\Vnet\Permissions $permissions
     */
    ...
    /**
     * @var \One\Vnet\Vnet\Template $template
     */
    private $template = null;

    /**
     * @var \One\Vnet\Vnet\ArPool\Ar[] $arPool
     */
    private $arPool = null;
     ...
     * Sets a new lock
     *
     * @param \One\Vnet\Vnet\Lock $lock
     * @return self
     */
    public function setLock(\One\Vnet\Vnet\Lock $lock)
    {
        $this->lock = $lock;
        return $this;
    }
     ...
     * Gets as permissions
     *
     * @return \One\Vnet\Vnet\Permissions
     */
     ...
     *
     * @param \One\Vnet\Vnet\Permissions $permissions
     * @return self
     */
    public function setPermissions(\One\Vnet\Vnet\Permissions $permissions)
    {
     ...
     * Sets a new template
     *
     * @param \One\Vnet\Vnet\Template $template
     * @return self
     */
    public function setTemplate(\One\Vnet\Vnet\Template $template)
    {
     ...
     */
    public function addToArPool(\One\Vnet\Vnet\ArPool\Ar $ar)
    {
        $this->arPool[] = $ar;
        return $this;
    }
     ...
     * Sets a new arPool
     *
     * @param \One\Vnet\Vnet\ArPool\Ar[] $arPool
     * @return self
     */
